...
public class Course_adapter extends RecyclerView.Adapter<Course_adapter.CourseViewHolder> {
    ...
    public Course_adapter(Context context, List<Course> courses) {
    ...
    public CourseViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new Course_adapter.CourseViewHolder(courseItems);
    }
    ...
    public void onBindViewHolder(@NonNull CourseViewHolder holder, int position) {
        ...
        int ImageId = context.getResources().getIdentifier(courses.get(position).getImg(), "drawable", context.getPackageName()); // Если что добавишь приписку "ic_"+
